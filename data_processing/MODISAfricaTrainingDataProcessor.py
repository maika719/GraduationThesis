"""
MODISAfricaImageProcessor

This script processes CSV files containing MODIS satellite data for Africa,
...
result_base_folder = './images/africa/0130/train/MODIS/' + datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
...
def process_files_in_date_range(start_month, end_month, start_day, end_day):
...
# Main function
def main():
    # Process CSV files from January 1 to December 20
    process_files_in_date_range(1, 12, 1, 20)
