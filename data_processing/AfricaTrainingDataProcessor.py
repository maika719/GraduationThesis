"""
AfricaTrainingDataProcessor

This script processes CSV files containing satellite data for Africa,
...
result_base_folder = './images/africa/sonomama/train/' + datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
